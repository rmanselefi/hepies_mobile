...
class PrescribeNarcoForm extends StatefulWidget {
  ...
  final Color color;
  var from;
  PrescribeNarcoForm(this.setPrescription, this.type, this.color, this.from);
  @override
                                        ...
                                        child: Container(
                                          ...
                                          child: Autocomplete(
                                            optionsBuilder:
                                              ...
                                              print(
                                                  "generalDrugsgeneralDrugs $psychoDrugs");
              ...
              Center(
                child: MaterialButton(
                  onPressed: () async {
                    ...
                    } else if (ageController.text == "" && !rememberMe) {
                      showTopSnackBar(
                        context,
                        CustomSnackBar.error(
