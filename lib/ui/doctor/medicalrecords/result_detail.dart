...
class ResultDetail extends StatefulWidget {
  ...
  final prescription;
  ResultDetail(
      this.patient, this.createdAt, this.professional, this.prescription);
  @override
...
class _ResultDetailState extends State<ResultDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    var prescription = widget.prescription;
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                ix.length!=0? _hematologyList(ix):Container(),
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 50.0),
                ...
                ix.length!=0?_chemistryList(ix):Container(),
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 50.0),
                ...
                ix.length!=0? _serologyList(ix):Container(),
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 50.0),
                ...
                ix.length!=0? _endocrinologyList(ix):Container(),
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(12.0),
